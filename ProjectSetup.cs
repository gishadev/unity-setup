...
namespace gishadev
{
    ...
    public static class ProjectSetup
    {
        ...
        static class Folders
        {
            ...
            // Deliberately a stub. The real overloads reference gishadev.tools types that aren't
            // installed yet at this point, and restating their signatures here would be a second
            // copy that drifts out of sync with the package. CodeGenerator fills this in the first
            // time GENERATE ENUMS runs on an AudioMasterSO / PoolDataSO.
            public static void CreateExtensionsClass(Action<string> log)
            {
                ...
                var str = new StringBuilder();
                str.AppendLine("// Auto-generated by gishadev.tools - do not edit.");
                str.AppendLine("// Populated by the GENERATE ENUMS button on AudioMasterSO / PoolDataSO.");
                str.AppendLine();
                ...
                log($"✓ Created extension methods stub: {path}");
            }
        }
    }
}
